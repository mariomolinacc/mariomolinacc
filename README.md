...
En su ejercicio actual, combina el **diseño, desarrollo y la administración de proyectos**, con el uso de herramientas avanzadas como **CAD, BIM, GIS** y **el desarrollo web**, lo que le permite crear visualizaciones y presentaciones sofisticadas para proyectos de infraestructura como viviendas, edificios y estructuras civiles.
